...
for imp in implementations:
  for n_p in num_parents:
    ...
    with open("results/output_"+imp+"_katsuura_"+n_p+".txt") as f:
      f.readline()
      f.readline()
      for k in range(0,30):
        fitness_values = []
    ...
    fitness_dataframe.to_csv("results/parsed/fitness_katsuura_"+imp+"_"+n_p+".csv")
    diversity_dataframe.to_csv("results/parsed/diversity_katsuura_"+imp+"_"+n_p+".csv")
